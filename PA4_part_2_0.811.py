...
# Extract BOW: return BOW featurized_data
...
# Extract Features: return featurized_data
def ExtractFeatures(data):
    ...
    for instance in data:
        ...
        for s in instance.snippet:
            ...
            # if (instance.relation is not 'NO_REL')  and hasattr(s, 'direction'):
        ...
        result = instance.entity_1 + ' ' + instance.entity_2 +' ' \
                 +' '.join(bow) +' ' + ' '.join(current_pos) \
                 + ' '+ ' '.join(current_syntax) + ' '+ s.direction
...
if __name__ == "__main__":
    ...
    args.train_path = 'train.json.txt'
    args.test_path = 'test.json.txt'
    args.result = 'test_labels.txt'
    ...
    clf = make_pipeline(CountVectorizer(
        ...
        # class_weight={0:0.185,1:0.190,2:0.195, 3:0.22, 4:0.210} #0.8095077750149103

        class_weight={1:0.185, 0:0.190, 3:0.195, 2:0.22, 4:0.210} # 0.8109109303234192

    # class_weight = {1: 0.185, 0: 0.190, 3: 0.195, 2: 0.22, 4: 0.210}
